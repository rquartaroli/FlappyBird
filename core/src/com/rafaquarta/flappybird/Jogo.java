package com.rafaquarta.flappybird;
...
public class Jogo extends ApplicationAdapter {
	...
	private void desenharTexturas(){
		...
		if(estadoJogo == 2){
			...
			textoReiniciar.draw(batch, "Toque para reinciiar!", larguraDispositivo/2 - 140, alturaDispositivo/2 - gameOver.getHeight()/2);
	...
	public void validarPontos(){
		...
		//Verifica variação para o bater de asas do passaro
		if (variacao > 3){
			variacao = 0;
		}
	}
